...
import cz.aurinet.tisk_kodu_cnc.ui.view_models.TiskPrikazViewModel;
...
public class TiskPrikazActivity extends AppCompatActivity{

    private static final int REQUEST_CAMERA_PERMISSION = 201;
    private static final int REFRESH_DELAY_MS = 5000;
    private final String NADPIS = "TISK KÓDŮ - CNC";
    ...
    private TiskPrikazViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayer = MediaPlayer.create(TiskPrikazActivity.this, R.raw.beep_err);
        singleton = ProcessMaterialPropertySingleton.INSTANCE;
        singleton.setDeviceName(Build.MANUFACTURER);
        handler = new Handler(Looper.getMainLooper());
        viewModel = new ViewModelProvider(this).get(TiskPrikazViewModel.class);
    ...
    private void initViews() {
        ...
        txtNadpis = findViewById(R.id.txt_verze);
        txtNadpis.setText(NADPIS);
    ...
    private void nextActivity(){
        Intent intent = new Intent(TiskPrikazActivity.this, CodePrintActivity.class);
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(TiskPrikazActivity.this , new
