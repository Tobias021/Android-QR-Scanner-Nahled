 ...
 */
class ProductionCloseActivity : AppCompatActivity(), View.OnClickListener {
    //Views
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //inicializuj utility
        mPlayer = MediaPlayer.create(this, R.raw.beep_err)
        handler = Handler.createAsync(Looper.myLooper()!!)
        nextIntent = Intent(this, OdvadeniPrikazActivity::class.java)
