...
import cz.aurinet.processmaterial_dim.ui.ProcessMaterialSwitchActivity;
...
public class StockMaterialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayer = MediaPlayer.create(StockMaterialActivity.this, R.raw.beep_err);
    ...
    private void nextActivity(){
        Intent intent = new Intent(StockMaterialActivity.this, ProcessMaterialSwitchActivity.class);
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(StockMaterialActivity.this , new
